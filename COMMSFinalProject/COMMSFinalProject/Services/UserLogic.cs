...
namespace COMMSFinalProject.Services 
{
    ...
    {
        public Task<User> Register(AddUser newUser);
    ...
    public class UserLogic : IUser
    {
        ...
        public UserLogic(UserContext context, IOptions<AppSettings> appSettings, ITokenMaker tokenParse)
        {
            _context = context;
        ...
        public async Task<User> Register(AddUser regData)
        {
            var user = new User();
            user.Role = Role.User;
